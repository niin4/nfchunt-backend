define({ "api": [
  {
    ...
    "group": "C__wamp64_www_nfc_hunt_api_public_apidoc_main_js",
    "groupTitle": "C__wamp64_www_nfc_hunt_api_public_apidoc_main_js",
    "name": ""
  },
  {
    "type": "post",
        ...
        "404 Not found": [
          {
            ...
            "optional": false,
            "field": "NoResults",
            "description": "<p>No results for game.</p>"
          }
        ],
        "500 Internal server error": [
          {
  ...
  },
  {
    ...
    "name": "PostTagsfound",
    "group": "Tags",
    "description": "<p>Try to post found tag, gives either error 304 of ducplicate entry or marks the tags as found. If player won the game status 303 is given</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "name": "LoginUser",
    "group": "Users",
    "description": "<p>Log in user. JWT access token returned as callback</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "500 Internal server error": [
          {
            ...
            "optional": false,
            "field": "DatabaseError",
            "description": "<p>Problem fetching data.</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "./routes/loginRoutes.js",
    "groupTitle": "Users"
  },
  {
    "type": "post",
    ...
    "name": "RegisterUser",
    "group": "Users",
    "description": "<p>Register user for creating, updating and deleting games. JWT access token returned as callback.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "500 Internal server error": [
          {
            ...
            "optional": false,
            "field": "DatabaseError",
            "description": "<p>Problem inserting data.</p>"
          }
        ]
      }
    },
